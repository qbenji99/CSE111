...
def count_genders(people_dict):
    ...
    print(f"Number of Women is {f_count}")
    print(f"Number of Men is {m_count}")
...
def print_marriages(marriages_dict, people_dict):
    ...
    for i in marriages_dict:
      mar_value = marriages_dict[i]

      husband_key = mar_value[HUSBAND_KEY_INDEX]
      wife_key = mar_value[WIFE_KEY_INDEX]
      marriage_year = mar_value[WEDDING_YEAR_INDEX]
      
      husband_value = people_dict[husband_key]
      husband_name = husband_value[NAME_INDEX]
      husband_birth = husband_value[BIRTH_YEAR_INDEX]
      
      wife_value = people_dict[wife_key]
      wife_name = wife_value[NAME_INDEX]
      wife_birth = wife_value[BIRTH_YEAR_INDEX]
